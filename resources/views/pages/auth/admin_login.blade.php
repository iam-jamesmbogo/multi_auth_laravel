        ...
        <div class="row">
          ...
          <div class="col-md-8 ps-md-0">
            <div class="auth-form-wrapper px-4 py-5">
              ...
              <h5 class="text-muted fw-normal mb-4"> Administrator Leaders Only! Log in to your account.</h5>
              ...
              @endif
              <form method="POST" action="{{ route('admin_login') }}" class="forms-sample">
                @csrf
                <div class="mb-3">
                ...
                <a href="{{ route('admin_register') }}" class="d-block mt-3 text-muted">Administrator? register here </a>
